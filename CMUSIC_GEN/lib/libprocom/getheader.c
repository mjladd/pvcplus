/* getheader.c	1.3	(CARL)	12 Sep 1986	16:29:11 */
...
extern int getpair(FILE *iop) ;
extern int gchar(char *cp, FILE *iop) ;
...
void bump(FILE *iop, short samplesize)
//	FILE *iop;
//	short samplesize;
{
	register struct fltbuf *fbp;
